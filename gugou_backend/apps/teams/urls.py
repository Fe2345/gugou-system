...
urlpatterns = [
    ...
    path("<str:team_id>/my-order/", TeamOrderDetailView.as_view(), name="team-order-detail"),
    path("<str:team_id>/pay/", TeamOrderPayView.as_view(), name="team-order-pay"),
    path("<str:team_id>/confirm/", TeamOrderConfirmView.as_view(), name="team-order-confirm"),
    path("<str:team_id>/return/", TeamOrderReturnView.as_view(), name="team-order-return"),
    # 管理员端接口
